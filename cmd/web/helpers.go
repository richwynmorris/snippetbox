...
// Render the template for the appropriate page by retriecing it from the cache
func (app *application) render(w http.ResponseWriter, r *http.Request, name string, td *templateData) {
	// retrieve template from cache - if no template, serverError is called
	...
	err := templateSet.Execute(buf, app.addDefaultData(td, r))
	if err != nil {
